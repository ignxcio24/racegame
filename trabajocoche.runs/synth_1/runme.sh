...
HD_PWD='C:/Xilinx/Vivado/trabajocoche/trabajocoche.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_r.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_r.tcl
