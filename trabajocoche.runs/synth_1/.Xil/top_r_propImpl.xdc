set_property SRC_FILE_INFO {cfile:C:/Xilinx/Vivado/trabajocoche/trabajocoche.srcs/constrs_1/imports/SED/Nexys-A7-100T-Master.xdc rfile:../../../trabajocoche.srcs/constrs_1/imports/SED/Nexys-A7-100T-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { modo_f }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
set_property src_info {type:XDC file:1 line:15 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { modo_m }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property src_info {type:XDC file:1 line:16 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { modo_d }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
