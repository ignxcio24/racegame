...
HD_PWD='C:/Xilinx/Vivado/trabajocoche/trabajocoche.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_r.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_r.tcl -notrace
